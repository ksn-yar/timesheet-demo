...
| `nelmio/cors-bundle`                  | Управление CORS-заголовками для API-запросов с других доменов.                |
...
| Пакет                               | Описание                                                                   |
|-------------------------------------|----------------------------------------------------------------------------|
| `dama/doctrine-test-bundle`         | Изоляция тестов через транзакции Doctrine без сброса базы данных.          |
...
| `doctrine/doctrine-fixtures-bundle` | Загрузка тестовых данных в базу данных через Doctrine фикстуры.            |
...
| `bootstrap`        | ^5.3.8   | CSS-фреймворк для стилизации компонентов                      |
| `bootstrap-icons`  | ^1.13.1  | Иконочный шрифт для Bootstrap                                 |
