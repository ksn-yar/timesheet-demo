...
/** Десериализует и валидирует DTO запроса на получение списка групп из query-параметров. */
#[AsTargetedValueResolver(ListGroupsRequestDto::class)]
final class ListGroupsValueResolver extends AbstractValueResolver
{
    protected function getDtoRequestClass(): string
    {
        return ListGroupsRequestDto::class;
    }
    ...
    protected function deserialize(Request $request, ArgumentMetadata $argument): object
    {
        ...
        return new ListGroupsRequestDto(
